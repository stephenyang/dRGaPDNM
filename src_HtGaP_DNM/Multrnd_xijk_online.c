        ...
        int nrhs, const mxArray *prhs[])
{
    ...
    if (iter==1)
    {
        ...
        {
            for (k = 0;k<Ksize;k++)
                m_i_dot_k[k+ i*Ksize] = m_i_dot_k[k+ i*Ksize]/batchfrac;
        } 
    }
    else
    {        
        ...
        {
            for (k = 0;k<Ksize;k++)
                m_i_dot_k[k+ i*Ksize] = (1 - gam_t) * m_i_dot_k_old[k+ i*Ksize] + gam_t * m_i_dot_k[k+ i*Ksize]/batchfrac;
        } 
